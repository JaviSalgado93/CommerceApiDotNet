...
public class AuthServiceTests
{
    ...
    public AuthServiceTests()
    {
        ...
        _mockConfiguration.Setup(x => x["Authentication:Issuer"]).Returns("CommerceApiDotNet");
        _mockConfiguration.Setup(x => x["Authentication:Audience"]).Returns("CommerceApiDotNet-Users");
